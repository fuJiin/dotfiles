;;; pop-rocks.el --- Emacs 24 theme with a dark background.
...
(deftheme pop-rocks)
 (let ((class '((class color) (min-colors 89)))
      ;;                                     GUI       TER
      (base       (if (display-graphic-p) "#b0b0b0" "#b0b0b0"))
      (cursor     (if (display-graphic-p) "white" "white"))
      (bg1        (if (display-graphic-p) "#171717" "#171717"))
      (bg2        (if (display-graphic-p) "#212026" "#1c1c1c"))
      (bg3        (if (display-graphic-p) "#1e1e1e" "#1e1e1e"))
      (bg4        (if (display-graphic-p) "#0a0814" "#080808"))
      (key1       (if (display-graphic-p) "#4f97d7" "#4f97d7"))
      (key2       (if (display-graphic-p) "#277bb8" "#277bb8"))
      (builtin    (if (display-graphic-p) "#728589" "#728589"))
      (keyword    (if (display-graphic-p) "#af8dfb" "#af8dfb"))
      (const      (if (display-graphic-p) "#fd82ad" "#fd82ad"))
      (comment    (if (display-graphic-p) "#636667" "#636667"))
      (comment-bg (if (display-graphic-p) "#171717" "#171717"))
      (func       (if (display-graphic-p) "#79e0f1" "#79e0f1"))
      (str        (if (display-graphic-p) "#c9ec79" "#c9ec79"))
      (type       (if (display-graphic-p) "#79e0f1" "#79e0f1"))
      (var        (if (display-graphic-p) "#728589" "#728589"))
      (err        (if (display-graphic-p) "#fa4786" "#fa4786"))
      (war        (if (display-graphic-p) "#fda739" "#fda739"))
      (inf        (if (display-graphic-p) "#79e0f1" "#79e0f1"))
      (suc        (if (display-graphic-p) "#c9ec79" "#c9ec79"))
      (green      (if (display-graphic-p) "#c9ec79" "#c9ec79"))
      (yellow     (if (display-graphic-p) "#e8dd8b" "#e8dd8b"))
      (cyan       (if (display-graphic-p) "#79e0f1" "#79e0f1"))
      (violet     (if (display-graphic-p) "#af8dfb" "#af8dfb"))
      (red        (if (display-graphic-p) "#fd82ad" "#fd82ad"))
      ...
      (highlight  (if (display-graphic-p) "#464f94" "#464f94")))
...
;;;;; basics
   ...
   `(font-lock-preprocessor-face ((,class (:foreground ,var))))
